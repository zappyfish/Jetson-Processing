...
const std::string jetson_file_manager::DIRECTORY_PATH[] = {"vadl", "flights"};
const int jetson_file_manager::PATH_LENGTH = 2;

jetson_file_manager::jetson_file_manager(std::string root_dir) : m_flight_path(root_dir) {
...
jetson_file_manager::jetson_file_manager() : jetson_file_manager(".") {

}

jetson_file_manager::~jetson_file_manager() {

}

size_t jetson_file_manager::get_flight_number() {
 ...
 */
void jetson_file_manager::write_line_to_file(std::string file_name, std::string line) {
...
void jetson_file_manager::multiline_write(std::string file_name, std::string lines[], size_t num_lines) {
    std::string full_path = m_flight_path + "/" + file_name;
    std::ofstream out;
    out.open(full_path, std::ios_base::app);
...
void jetson_file_manager::multiline_write(std::string file_name, std::vector<std::string> lines) {
    std::string full_path = m_flight_path + "/" + file_name;
    std::ofstream out;
    out.open(full_path, std::ios_base::app);
