...
flags.DEFINE_string('file_extension', 'jpg', 'Image data file extension of '
...
flags.DEFINE_bool('egomotion', True, 'Determines if the egomotion prediction '
  ...
  with sv.managed_session() as sess:
    ...
    if depth:
      ...
      for i in range(len(im_files)):
        ...
        print("not running depth network")
    ...
    if egomotion:
      ...
      logging.info("took %f seconds" % (time.time() - t1))
      logging.info('Done.')
