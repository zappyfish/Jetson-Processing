...
# util.get_imagenet_vars_to_restore('/Users/liamkelly/vadl/models/research/struct2depth/resnet_pretrained/model.ckpt-225207')

gfile = tf.gfile
MAX_TO_KEEP = 1000000  # Maximum number of checkpoints to keep.

flags.DEFINE_string('data_dir', None, 'Preprocessed data.')
flags.DEFINE_string('file_extension', 'jpg', 'Image data file extension.')
...
flags.DEFINE_float('size_constraint_weight', 0.0000, 'Weight of the object '
                   'size constraint loss. Use only when motion handling is '
                   'enabled.') # TODO: Change bck to 0.0005
...
flags.DEFINE_bool('handle_motion', False, 'Whether to try to handle motion by '
                  'using the provided segmentation masks.') # TODO: Change me if necessary
