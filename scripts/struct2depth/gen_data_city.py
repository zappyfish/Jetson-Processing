...
HEIGHT = 128
SUB_FOLDER = 'train'
INPUT_DIR = '/Users/liamkelly/vadl/models/research/struct2depth/cityscapes_data/raw/leftImg8bit_trainvaltest'
OUTPUT_DIR = '/Users/liamkelly/vadl/models/research/struct2depth/cityscapes_data/processed'
...
def run_all():
  dir_name=INPUT_DIR + '/leftImg8bit/' + SUB_FOLDER + '/*'
  print('Processing directory', dir_name)
  for location in glob.glob(dir_name):
